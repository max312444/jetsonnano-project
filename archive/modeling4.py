...
# 데이터 경로 설정
base_path = r"C:\Users\USER\dataset_0117\lastdance_csv.csv"
frame_save_path = os.path.join(base_path, r"C:\Users\USER\mydataset")
csv_file = os.path.join(base_path, r"C:\Users\USER\dataset_0117\lastdance_csv.csv")
